...
local CONFIG = {
	KEYS = {
		...
		"af4d06e1bf0cbdbb68d4df8fc901a805",
		"5axc85291z8k5b62j5012a55fhbal62hb"
	},
	MAX_ATTEMPTS = 3,
...
-- Run the key system
runKeySystem()
getgenv().Key = "MARU-LN0PU-WM7Z7-VJ4N-8QG22-SFG2L"
getgenv().id = "1291987571995443270"
